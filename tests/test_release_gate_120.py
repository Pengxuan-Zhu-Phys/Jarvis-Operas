...
def test_release_120_fixed_functions_support_scalar_array_sync_async_and_dual_backends() -> None:
    ...
    fixed_cases: dict[str, dict[str, Any]] = {
        ...
        "helper.eggbox": {
            ...
            "numpy_scalar_expected": 93.70340035799192,
            "numpy_array_kwargs": {
                "x": np.array([0.0, 0.5]),
                "y": np.array([0.0, 0.0]),
            },
            "numpy_array_expected": np.array([32.0, 93.70340035799192]),
            "polars_args": (),
            "polars_kwargs": {"x": pl.col("x"), "y": pl.col("y")},
            "polars_frame_single": pl.DataFrame({"x": [0.5], "y": [0.0]}),
            "polars_expected_single": [93.70340035799192],
            "polars_frame_many": pl.DataFrame({"x": [0.0, 0.5], "y": [0.0, 0.0]}),
            "polars_expected_many": [32.0, 93.70340035799192],
        },
        "helper.eggbox2d": {
            "numpy_scalar_kwargs": {"x": 0.5, "y": 0.0},
            "numpy_scalar_expected": {"z": 93.70340035799192},
            "numpy_array_kwargs": {
                "x": np.array([0.0, 0.5]),
                "y": np.array([0.0, 0.0]),
            },
            "numpy_array_expected": {"z": np.array([32.0, 93.70340035799192])},
            "polars_args": (),
            "polars_kwargs": {"x": pl.col("x"), "y": pl.col("y")},
            "polars_frame_single": pl.DataFrame({"x": [0.5], "y": [0.0]}),
            "polars_expected_single": [{"z": 93.70340035799192}],
            "polars_frame_many": pl.DataFrame({"x": [0.0, 0.5], "y": [0.0, 0.0]}),
            "polars_expected_many": [{"z": 32.0}, {"z": 93.70340035799192}],
        },
        "stat.chi2_cov": {
            "numpy_scalar_kwargs": {
